/*
	Mercenaries Mission Z-Theme Variation with new difficulty selection system
	Created by Defent and eraser1
	easy/mod/difficult/hardcore - reworked by [CiC]red_ned http://cic-gaming.co.uk
*/

private ["_num", "_side", "_OK", "_group", "_pos", "_difficulty", "_AICount", "_type", "_launcher", "_crate", "_crate_loot_values", "_missionAIUnits", "_missionObjs", "_msgStart", "_msgWIN", "_msgLOSE", "_missionName", "_markers", "_time", "_added", "_cleanup", "_crate_weapons", "_crate_weapon_list", "_crate_items", "_crate_item_list", "_crate_backpacks", "_PossibleDifficulty", "_customGearSet"];
...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION mercenariesZ.sqf with invalid parameters: %1",_this];
};
...
_msgStart = ['#FFFF00',format["A group of %1 test subjects has escaped from a research centre. Kill them and stop the infection",_difficulty]];

// Define Mission Win message
_msgWIN = ['#0080ff',"Convicts have successfully eliminated the test subjects and stopped the virus spreading!"];

// Define Mission Lose message
_msgLOSE = ['#FF0000',"The test subjects have escaped, this will not help stop the spread of zombies!"];

// Define mission name (for map marker and logging)
_missionName = "Test Subjects";

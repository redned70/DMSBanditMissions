/*
	Bandits Mission Theme Variation with new difficulty selection system
...
if !(_OK) exitWith
{
	diag_log format ["DMS ERROR :: Called MISSION banditsZ.sqf with invalid parameters: %1",_this];
};
...
_msgStart = ['#FFFF00',format["A heavily group of infected %1 soldiers escaped a lab in a vehicle, kill them before it spreads!",_difficulty]];

// Define Mission Win message
_msgWIN = ['#0080ff',"Convicts have killed the infected soldiers and the infection has been contained, for now!"];

// Define Mission Lose message
_msgLOSE = ['#FF0000',"The infected soldiers have driven off, the infection continues to spread!"];

// Define mission name (for map markers, mission messages, and logging)
_missionName = "The Infected";
